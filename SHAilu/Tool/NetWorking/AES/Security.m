...
#define SEFFDDFDDF @"I@9_7*b^6!qpz%j&"
...
//    NSString *key=@"ibz.123456.AaZz.&*("; // 密钥
//    NSString *pwdString = [str md5];
    
    NSData *data=[str dataUsingEncoding:NSUTF8StringEncoding]; // 待加密字符转为NSData型
    char keyPtr[kCCKeySizeAES128 + 1];
    memset(keyPtr, 0, sizeof(keyPtr));
    [SEFFDDFDDF getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSUTF8StringEncoding];
