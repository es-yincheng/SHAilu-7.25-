...
@interface YCTabBar()<UITabBarDelegate>{
    NSInteger itemCount;
}
...
- (void)setupMaskLayer {
    ...
    colorMaskView.backgroundColor = [UIColor redColor];
...
//    NSArray *colors = [self itemColors];
    ...
    for (int i = 0; i < itemCount; i ++) {
        ...
        view.backgroundColor = YCNavTitleColor;
        self.colorfulView.backgroundColor = [UIColor redColor];
