...
//    [self.loadButton setTitle:[NSBundle jsq_localizedStringForKey:@"load_earlier_messages"] forState:UIControlStateNormal];
    [self.loadButton setTitle:@"加载更多历史记录" forState:UIControlStateNormal];
    [self.loadButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
//    self.loadButton.titleLabel.font = [UIFont preferredFontForTextStyle:UIFontTextStyleBody];
    self.loadButton.titleLabel.font = [UIFont systemFontOfSize:12];
}
