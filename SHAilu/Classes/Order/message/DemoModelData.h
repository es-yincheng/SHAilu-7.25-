...
static NSString * const kJSQDemoAvatarDisplayNameCook = @"";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"";
static NSString * const kJSQDemoAvatarDisplayNameWoz = @"";
